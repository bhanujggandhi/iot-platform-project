...
if __name__ == "__main__":
    ...
    lbl_cnt = lbl_ae
    create_cnt(server+cse+ae + "/" + node_container_name,
               descriptor_container_name, lbl_cnt)
    # create cnt in descriptor container
    for label in lbl_ae:
        val = ["TimeStamp", "Occupancy", "Value"]
        create_data_cin(server+cse+ae + "/" + node_container_name +
                        "/" + descriptor_container_name, val, label)

    data_container_name = "Data"
    lbl_cnt = lbl_ae
    create_cnt(server+cse+ae + "/" + node_container_name,
               data_container_name, lbl_cnt)
