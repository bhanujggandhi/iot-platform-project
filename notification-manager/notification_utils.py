...
class Notification:
    def __init__(self):
        try:
            ...
            logger.log(service_name = SERVICE_NAME, level = 0, msg = 'Login successful on SMTP Server.')

        except Exception as e:
            print(e)
            print("Unable to login Email.")
            logger.log(service_name = SERVICE_NAME, level = 4, msg = 'Login failure on SMTP Server.')
